...
\addtofrontsidebar{
	...
	\profilesection{Online Profiles}
        ...
        \begin{minipage}{0.65\textwidth}
            \centering
            \color{cvblue!70!blue}
            \qrcode[height=3.5cm]{https://linktr.ee/aemerinot}\\[2mm]
            \color{black}\href{https://linktr.ee/aemerinot}{linktr.ee/aemerinot}
        \end{minipage}
        \end{center}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\cventry{nov-2025}
    {Presentation: Exploring the Didactic Potential of ChatGPT Hallucinations in Teaching}
    {VII Congreso Iternacional de Tecnología y Educación - TEDUCA 2025}
...
\cvsignature[Update to]{February 26, 2026}
