...
\cventry{feb-2026}
    ...
    {}
    {Sociedad Ecuatoriana de Estadística (40 horas)}
    
\cventry{nov-2025}
    {Ponencia: Exploración del potencial didáctico de las alucinaciones del ChatGPT en la enseñanza}
...
\cventry{ene-2026}
    {Aplicación del análisis topológico de datos}
...
\cventry{sep-2025}
    {Procesamiento Digital de Imágenes con Python y Open CV}
    {umaker}
    {Perú (40 horas)}
...
\cvpubitem{abr-2026}
    {Artículo científico}
    {Merino, A. y Heredia, S. (2026). A primitive associated with the Cantor–Bendixson derivative on Polish spaces. CUBO, 28(2), 227-245.}
    {\url{https://doi.org/10.56754/0719-0646.2802.227}}
...
\cvsignature{16 de abril de 2026}
